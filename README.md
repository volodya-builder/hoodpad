# hood — токен-лаунчпад для Robinhood Chain
...
| Доля создателя в комиссии | **20%** — с первого трейда |
| Казна выкупа | **80%** комиссий; ETH из казны тратится только на выкуп токенов (вывода нет), выкупленное можно сжечь |
...
- **Революционное распределение дохода: 20% создателю, 80% — на выкуп токенов платформы.** BuybackTreasury не имеет функции вывода ETH — только buyback и burn, это проверяется в блокчейне;
