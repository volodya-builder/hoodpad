...
/// @dev Минимальный WETH9 для тестов против настоящего Uniswap V3
///      (NonfungiblePositionManager зовёт deposit/withdraw/transfer).
contract WETH9Test {
    ...
    function approve(address guy, uint256 wad) external returns (bool) { allowance[msg.sender][guy] = wad; emit Approval(msg.sender, guy, wad); return true; }
