...
const EN = {
  ...
  "включён": "on",
  "выключен": "off",
  "Выдаст тебе все 10 000 боксов, чтобы обкатать цикл: открытие кейсов, коллекция, биржа, дивиденды. Состояние хранится только в этом браузере.": "Grants you all 10,000 boxes to exercise the full loop: opening cases, collection, market, dividends. State lives only in this browser.",
  "Выдать себе 10 000 боксов": "Grant me 10,000 boxes",
  "боксов у меня": "my boxes",
  "открыто": "opened",
  "дивидендов": "dividends",
  "на бирже": "listed",
  "Раздать дивиденды из казны": "Distribute treasury dividends",
