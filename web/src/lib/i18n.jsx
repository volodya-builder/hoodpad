...
const EN = {
  ...
  "Каждый день казна тратит 50% баланса на подиум: 50% — 1 месту, 30% — 2 месту, 20% — 3 месту. Выкуп токена с рынка и сжигание. Исполняется автоматически утром следующего дня.": "Every day the treasury spends 50% of its balance on the podium: 50% to 1st, 30% to 2nd, 20% to 3rd. Market buyback and burn. Executed automatically the next morning.",
  "Призы казны": "Treasury prizes",
  "Каждый день казна тратит 50% своего баланса на подиум арены: 50% фонда — 1 месту, 30% — 2 месту, 20% — 3 месту.": "Every day the treasury spends 50% of its balance on the arena podium: 50% of the pot to 1st place, 30% to 2nd, 20% to 3rd.",
