...
const EN = {
  ...
  "Каждый день казна тратит 10% баланса на подиум: 50% — 1 месту, 30% — 2 месту, 20% — 3 месту. Выкуп токена с рынка и сжигание. Исполняется автоматически утром следующего дня.": "Every day the treasury spends 10% of its balance on the podium: 50% to 1st, 30% to 2nd, 20% to 3rd. Market buyback and burn. Executed automatically the next morning.",
  "Призы казны": "Treasury prizes",
  "Каждый день казна тратит 10% своего баланса на подиум арены: 50% фонда — 1 месту, 30% — 2 месту, 20% — 3 месту.": "Every day the treasury spends 10% of its balance on the arena podium: 50% of the pot to 1st place, 30% to 2nd, 20% to 3rd.",
  ...
  "Ритмы казны: подиум арены — ежедневно 10% баланса, голосование — еженедельно 30%, Гранд-выкуп — ежемесячно 20%. Проценты от текущего баланса: казна никогда не пустеет.": "Treasury rhythms: arena podium — 10% of balance daily, voting — 30% weekly, Grand Buyback — 20% monthly. Percentages of the current balance: the treasury never runs dry.",
