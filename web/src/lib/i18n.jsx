...
const EN = {
  ...
  "Каждый день казна тратит 25% баланса на подиум: 50% — 1 месту, 30% — 2 месту, 20% — 3 месту. Выкуп токена с рынка и сжигание. Исполняется автоматически утром следующего дня.": "Every day the treasury spends 25% of its balance on the podium: 50% to 1st, 30% to 2nd, 20% to 3rd. Market buyback and burn. Executed automatically the next morning.",
  "Призы казны": "Treasury prizes",
  "Каждый день казна тратит 25% своего баланса на подиум арены: 50% фонда — 1 месту, 30% — 2 месту, 20% — 3 месту.": "Every day the treasury spends 25% of its balance on the arena podium: 50% of the pot to 1st place, 30% to 2nd, 20% to 3rd.",
  ...
  "Ритмы казны: подиум арены — ежедневно 25% баланса (главный акцент), голосование — еженедельно 20%, Гранд-выкуп — ежемесячно 20%. Проценты от текущего баланса: казна никогда не пустеет, а дневной приз растёт вместе с оборотом.": "Treasury rhythms: arena podium — 25% of balance daily (the main focus), voting — 20% weekly, Grand Buyback — 20% monthly. Percentages of the current balance: the treasury never runs dry, and the daily prize grows with trading volume.",
