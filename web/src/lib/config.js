...
export const FEATURES = {
  ...
  // Запуск монеты, ТОРГУЮЩЕЙСЯ за акцию/крипту (модель flap и Pons: «paired
  // asset»). Скрыт 14.09.2026 решением владельца: монеты hood торгуются
  // всегда за ETH, а акция/крипта — это валюта ДИВИДЕНДОВ, не торговли.
  // Контракты (quote-фабрика 0xd729…9a4f) остаются в мейннете, страницы
  // уже запущенных за валюту монет работают. Включается одним флагом.
  quoteLaunch: false,
};
