...
const SUBGRAPH_VERSIONS = ["4.0.2", "4.0.1"]; // 4.0.2: трейдер через зап = отправитель tx (PnL); первая отвечающая версия // 4.0.0 был с graft от старых фабрик — не использовать
