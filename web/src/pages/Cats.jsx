...
const RARITIES = [
  ...
  { key: "Rare", ru: "Редкий", chance: 25, mult: 2, color: "#4aa3e0" },
  { key: "Epic", ru: "Эпический", chance: 11, mult: 3, color: "#a06bff" },
  { key: "Legendary", ru: "Легендарный", chance: 4, mult: 5, color: "#f5b544" },
];
...
export default function Cats() {
  ...
  const faq = [
    ...
    [t("Как влияет редкость?"), t("Редкость задаёт вес кота при каждом распределении: Обычный ×1, Редкий ×2, Эпический ×3, Легендарный ×5. Легендарный кот получает в 5 раз больше акций с каждого транша, чем Обычный.")],
      ...
      <div className="rev-calc">
        <div className="rev-sliders">
          <label>
            ...
            <input type="range" min="0" max="3" step="1" value={ranges.tier} onChange={set("tier")} />
          </label>
          <label>
