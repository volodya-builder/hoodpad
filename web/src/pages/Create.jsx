    ...
    <div className="create-layout">
      ...
      <aside className="preview-card">
        ...
        <div className="preview-stats">
          ...
          <div className="row"><span className="k">Вам с каждого трейда</span><span className="v green">{split.creator}% комиссии</span></div>          <div className="row"><span className="k">Градация</span><span className="v">6.5 ETH</span></div>
