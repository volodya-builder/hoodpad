      ...
      {st && st.participants.length > 0 && (
        <div className="arena-main">
          ...
          {view === "rules" && (
            <div className="arena-rules">
              {[
                ...
                [t("Призы казны"), [
                  t("Каждый день казна тратит 10% своего баланса на подиум арены: 50% фонда — 1 месту, 30% — 2 месту, 20% — 3 месту."),
                  ...
                  t("Ритмы казны: подиум арены — ежедневно 10% баланса, голосование — еженедельно 30%, Гранд-выкуп — ежемесячно 20%. Проценты от текущего баланса: казна никогда не пустеет."),
                ]],
          ...
          <div className="arena-bar">
            ...
            <div className="ab-cell">
              <span>{t("Призы дня")} <i title={t("Каждый день казна тратит 10% баланса на подиум: 50% — 1 месту, 30% — 2 месту, 20% — 3 месту. Выкуп токена с рынка и сжигание. Исполняется автоматически утром следующего дня.")}>ⓘ</i></span>
              <b>
                {treBal === null ? "…" : (() => {
                  const pot = treBal * 0.10;
