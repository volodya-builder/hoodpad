...
// Экономика (решение владельца 15.09.2026): 10% каждой комиссии платформы
    ...
    <>
      <div className="ana-head">
        <div>
          ...
          <div className="ana-panel-sub">{t("Суточный бой по честному объёму. 10% комиссий платформы — каждое утро выкуп и сжигание монет подиума.")}</div>
        </div>
              ...
              <div className="arena-pot-places">
                {SPLIT.map((pct, i) => (
                  <div className={`arena-pot-place p${i + 1}`} key={pct}>
                    <div className="l"><i /> {i + 1} {t("место")} <span className="pct">{pct}%</span></div>
