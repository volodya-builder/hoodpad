      ...
      {st && st.participants.length > 0 && (
        <div className="arena-main">
          ...
          {view === "rules" && (
            <div className="arena-rules">
              {[
                ...
                [t("Призы казны"), [
                  t("Каждый день казна тратит 50% своего баланса на подиум арены: 50% фонда — 1 месту, 30% — 2 месту, 20% — 3 месту."),
                  ...
                  t("Ритмы казны: подиум арены — ежедневно 50% баланса (главный акцент), голосование — еженедельно 20%, Гранд-выкуп — ежемесячно 30%. Проценты от текущего баланса: казна никогда не пустеет, а дневной приз растёт вместе с оборотом."),
                ]],
          ...
          <div className="arena-bar">
            ...
            <div className="ab-cell">
              <span>{t("Призы дня")} <i title={t("Каждый день казна тратит 50% баланса на подиум: 50% — 1 месту, 30% — 2 месту, 20% — 3 месту. Выкуп токена с рынка и сжигание. Исполняется автоматически утром следующего дня.")}>ⓘ</i></span>
              <b>
                {treBal === null ? "…" : (() => {
