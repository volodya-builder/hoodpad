        ...
        <div className="container header-inner">
          <a className="logo" href="#/" aria-label="hood">
            <svg width="32" height="32" viewBox="0 0 64 64">
              <defs>
                <linearGradient id="lgHood" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0" stopColor="#55585c" />
                  <stop offset="0.5" stopColor="#6f7378" />
                  <stop offset="1" stopColor="#9da1a6" />
                </linearGradient>
                <linearGradient id="lgFace" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0" stopColor="#191a1c" />
                  <stop offset="1" stopColor="#050606" />
                </linearGradient>
              </defs>
              <rect width="64" height="64" rx="14" fill="#f5f5f2" />
              <path d="M32 8.6 C30 8.6 27.6 11 25.4 14.2 C20.4 21.4 15.2 31.6 13.2 41 C12.2 45.4 12.7 48.7 15.3 50.5 C17.9 52.2 23 51.3 32 51.3 C41 51.3 46.1 52.2 48.7 50.5 C51.3 48.7 51.8 45.4 50.8 41 C48.8 31.6 43.6 21.4 38.6 14.2 C36.4 11 34 8.6 32 8.6 Z" fill="url(#lgHood)" />
              <path d="M32 25 C26.6 28.6 20.6 35.4 20.1 42.6 C19.8 46 21 48.4 22.5 50.2 C23.6 51.6 24 53 25.4 54.1 C27.2 55.4 29.4 55.8 32 55.8 C34.6 55.8 36.8 55.4 38.6 54.1 C40 53 40.4 51.6 41.5 50.2 C43 48.4 44.2 46 43.9 42.6 C43.4 35.4 37.4 28.6 32 25 Z" fill="url(#lgFace)" stroke="#ffffff" strokeWidth="2.1" />
            </svg>
