...
//  Звать migrate() может кто угодно — раньше это была кнопка на сайте, и
//  между заполнением кривой и нажатием монету нельзя было ни купить, ни
//  продать. Теперь это делает бот: каждые полминуты смотрит события
//  Graduated у всех пулов обеих фабрик и зовёт migrate() у тех, кто ещё
//  не мигрировал. Бот только платит газ; деньги идут по коду пула.
//
