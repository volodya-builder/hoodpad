import{C as e,K as t,R as n,Y as r,q as i,y as a}from"./ApiController-DVC1vRFm.js";import{_ as o,c as s,f as c,o as l}from"./exports-ClBc5snA.js";import{l as u,o as d,u as f}from"./wui-text-CHT8qwsR.js";import"./wui-icon-C9RQLkXg.js";var p=i({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=n({state:p,subscribe(e){return r(p,()=>e(p))},subscribeKey(e,n){return t(p,e,n)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=o`
  :host {
    width: 100%;
    display: block;
  }
