import{C as e,P as t,U as n,V as r,at as i,h as a,r as o,x as s,y as c}from"./ApiController-Cf73EOIf.js";import{c as l,f as u,o as d,r as f,t as p}from"./exports-ClBc5snA.js";import{l as m,o as h,u as g}from"./wui-text-B4TTgusF.js";import{t as _}from"./SwapController-DM4vDDMI.js";import"./w3m-tooltip-vSuREofb.js";import{t as v}from"./MathUtil-B2UslVSw.js";import"./wui-button-DSQg8-Dc.js";import"./wui-icon-CO9CVtiu.js";import"./wui-image-DxL4c3tr.js";import"./wui-shimmer-C0KuSq1O.js";import"./wui-shimmer-DuZRbCTK.js";import"./wui-icon-box-25HRIiwZ.js";import"./wui-input-text-DX8fxeGk.js";import"./wui-token-button-VEMoShCk.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t?.includes(`.`)||t?.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=d`
  :host {
    width: 100%;
  }
