import{C as e,P as t,U as n,V as r,at as i,h as a,r as o,x as s,y as c}from"./ApiController-HkzmXIFY.js";import{c as l,f as u,o as d,r as f,t as p}from"./exports-ClBc5snA.js";import{l as m,o as h,u as g}from"./wui-text-CHT8qwsR.js";import{t as _}from"./SwapController-DqxGmmEl.js";import"./w3m-tooltip-8IymBz80.js";import{t as v}from"./MathUtil-B2UslVSw.js";import"./wui-button-BGnwBRIj.js";import"./wui-icon-C9RQLkXg.js";import"./wui-image-DykLASQL.js";import"./wui-shimmer-BNfGZi2j.js";import"./wui-shimmer-C-80YCXB.js";import"./wui-icon-box-B_dZs8ZY.js";import"./wui-input-text-DBjsfi1I.js";import"./wui-token-button-CtpaAqlz.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t?.includes(`.`)||t?.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=d`
  :host {
    width: 100%;
  }
