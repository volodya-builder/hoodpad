...
export class Token extends Entity {
  ...
  set quote(value: Bytes | null) {
    if (!value) {
      this.unset("quote");
    } else {
      this.set("quote", Value.fromBytes(<Bytes>value));
    }
  }

  get divBps(): i32 {
    let value = this.get("divBps");
    if (!value || value.kind == ValueKind.NULL) {
      return 0;
    } else {
      return value.toI32();
  ...
  set divBps(value: i32) {
    this.set("divBps", Value.fromI32(value));
  }
